...
export default function FeaturedGuides(){
    return (
        <div className="featured-guides">
             <h1 className="display-6 text-capitalize mb-3">Get Inspiration for Your Next Trip</h1>
             <div className="row g-4 me-0">
                <div className="col-12 col-md-4">
                    <div className="card position-relative">
                        <img src={Sydeny} className="card-img-top rounded-3 custom__img" alt="Sydeny’s-h" />
                ...
                <div className="col-12 col-md-4">
                    <div className="card position-relative">
                        <img src={restaurant} className="card-img-top rounded-3 custom__img" alt="restaurant" />
                        <div className="card-body position-absolute bottom-0 text-light">
                ...
                <div className="col-12 col-md-4">
                    <div className="card position-relative">
                        <img src={greenMountains} className="img-fluid rounded-3  custom__img" alt="greenMountains" />
                        <div className="card-body position-absolute bottom-0 text-light">
                            <h3 className="card-title">World’s top destinations during and post covid timeline</h3>
                            <p className="card-text">                  Pandemic is still intact and will be here for a longer time.
                            Here’s where your next destination...</p>
                        </div>
                    </div>
                </div>
             </div>
